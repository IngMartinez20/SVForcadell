Use Master
Go
If(db_id('Forcadell')Is Not Null)
Drop DataBase Forcadell
Create DataBase Forcadell
Go
...
Insert Categoria Values('Grabado'),('Dibujo'),('imprenta')
Go
...
Insert Producto Values(1,'Dibujo','mariposa',5,4.90,5.90,'11/03/2020')
Go
...
Go
Insert Empleado Values(1,'2020','Mijarex Lopez','Mijarex','M','03/04/2020','Los mina','S')
Go
Insert Usuario Values(1,'Mijarex','123456')
Go
